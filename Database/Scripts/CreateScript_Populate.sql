...
VALUES ('0', 'Informática', 'Produtos tecnólogicos de uso geral e específico no mundo da tecnologia da informação');
/* INSERÇÃO INICIAL*/
...
CALL cadastrarLocal(2, "Livraria Nobel",  1, '10:00:00', '17:59:59',"7deafe8a-f928-11ea-adc1-0242ac120002");
CALL cadastrarLocal(2, "Livraria Martins Fontes",  1, '10:00:00', '22:59:59',"7deafe8a-f928-11ea-adc1-0242ac120002");

	
CALL cadastrarLocal(0, "Lojas Americanas",  0, '09:00:00', '22:30:00', "7deaf908-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(6, 0);
CALL defCategoriaLocal(6, 1);
CALL defCategoriaLocal(6, 2);
CALL defCategoriaLocal(6, 3);
CALL defCategoriaLocal(6, 4);
CALL defCategoriaLocal(6, 5);
CALL defCategoriaLocal(6, 6);
CALL defCategoriaLocal(6, 7);
CALL defCategoriaLocal(6, 8);
CALL defCategoriaLocal(6, 9);
...
CALL defCategoriaLocal(7, 1);
CALL defCategoriaLocal(7, 2);
CALL defCategoriaLocal(7, 5);
CALL defCategoriaLocal(7, 6);
CALL defCategoriaLocal(7, 8);
CALL defCategoriaLocal(7, 9);
...
CALL defCategoriaLocal(8, 0);
CALL defCategoriaLocal(8, 2);
...
CALL defCategoriaLocal(9, 0);
CALL defCategoriaLocal(9, 2);
...
CALL defCategoriaLocal(10, 0);
CALL defCategoriaLocal(10, 2);

CALL cadastrarLocal(0, "Shoulder",  1, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(11, 4);
CALL publicarComunicado(11, 3, null, "Cuidado! Entrada escorregadia!", now(), DATE_ADD(now(), INTERVAL 30 minute));

CALL cadastrarLocal(0, "Havaianas",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(12, 4);
CALL publicarComunicado(12, 0, null, "Pagando no cartão, você ganha 15% de desconto!", now(), null);

CALL cadastrarLocal(0, "Carmen Steffens",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(13, 4);

CALL cadastrarLocal(0, "Sthill",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(14, 4);

CALL cadastrarLocal(0, "SPOT",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(15, 4);

CALL cadastrarLocal(0, "Mahogany",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(16, 4);

CALL cadastrarLocal(0, "Program Moda",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(17, 4);

CALL cadastrarLocal(0, "Belliótica",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(18, 4);

CALL cadastrarLocal(0, "Mão Única",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(19, 1);
CALL defCategoriaLocal(19, 2);
CALL defCategoriaLocal(19, 5);
CALL defCategoriaLocal(19, 6);
CALL defCategoriaLocal(19, 8);
CALL defCategoriaLocal(19, 9);
...
CALL cadastrarLocal(0, "Pontal",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(20, 4);


CALL cadastrarLocal(0, "Stilleto",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(21, 4);


CALL cadastrarLocal(0, "Clube Melissa",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(22, 4);

CALL cadastrarLocal(0, "Hawaii Surf Point",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(23, 4);


CALL cadastrarLocal(0, "RetrôMania",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(24, 4);


CALL cadastrarLocal(0, "Reserva",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(25, 4);


CALL cadastrarLocal(0, "Polo Play",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(26, 4);


CALL cadastrarLocal(0, "Maybelline NY",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(27, 4);


CALL cadastrarLocal(0, "Arezzo",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(28, 4);


CALL cadastrarLocal(0, "Authentic Feet",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(29, 4);


CALL cadastrarLocal(0, "Tennis Station",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(30, 4);


CALL cadastrarLocal(0, "Piticas",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(31, 4);


CALL cadastrarLocal(0, "Casa das Cuecas",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(32, 4);


CALL cadastrarLocal(0, "Puket",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(33, 4);


CALL cadastrarLocal(0, "Brooksfield",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(34, 4);


CALL cadastrarLocal(0, "Sapataria do Futuro",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(35, 4);


CALL cadastrarLocal(0, "Coisas da Casa",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(36, 6);


CALL cadastrarLocal(0, "Simplesmente Bárbara",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(37, 4);


CALL cadastrarLocal(0, "Fast Shop",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(38, 0);
CALL defCategoriaLocal(38, 2);
CALL defCategoriaLocal(38, 3);
...
CALL cadastrarLocal(0, "A Esportiva",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(39, 4);


CALL cadastrarLocal(0, "Cacau Show",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(40, 7);


CALL cadastrarLocal(0, "LOFT",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(41, 4);

CALL cadastrarLocal(0, "Relicário",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(42, 4);

CALL cadastrarLocal(0, "Andisport Futebol",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(43, 4);

CALL cadastrarLocal(0, "Le Postiche",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(44, 4);

CALL cadastrarLocal(0, "Crocs",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(45, 4);

CALL cadastrarLocal(0, "Criatiff",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(46, 4);

CALL cadastrarLocal(0, "Bluebeach",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(47, 4);

CALL cadastrarLocal(0, "SIDE WALK",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(48, 4);

CALL cadastrarLocal(0, "Usaflex",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(49, 4);


CALL cadastrarLocal(0, "Beautybox",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(50, 11);

CALL cadastrarLocal(0, "Kyowa",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(51, 13);

CALL cadastrarLocal(0, "Chilli Beans",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(52, 4);

CALL cadastrarLocal(0, "Adcos",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(53, 11);

CALL cadastrarLocal(0, "PUC",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(54, 4);

CALL cadastrarLocal(0, "M&M Santos",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(55, 0);
CALL defCategoriaLocal(55, 2);

CALL cadastrarLocal(0, "Maze",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(56, 4);

CALL cadastrarLocal(12, "Estúdio de Sombrancelha",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");

CALL cadastrarLocal(0, "Quem disse, Berenice?",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(58, 4);

CALL cadastrarLocal(12, "AngioCorpore",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");

CALL cadastrarLocal(0, "O'Clus Personal Ótica",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(60, 4);

CALL cadastrarLocal(0, "Fabiana Zaitun",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(61, 4);

CALL cadastrarLocal(12, "Doctor Feet",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");

CALL cadastrarLocal(0, "Nutty Bavarian",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(63, 7);

CALL cadastrarLocal(0, "L'Occitane en Provence",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(64, 4);

CALL cadastrarLocal(0, "Planet Girls",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(65, 4);

CALL cadastrarLocal(0, "Kopenhagen",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(66, 7);

CALL cadastrarLocal(0, "Mr. CAT",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(67, 4);

CALL cadastrarLocal(0, "Club Pitanga",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(68, 4);

CALL cadastrarLocal(0, "Mega Body Store",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(69, 4);

CALL cadastrarLocal(0, "Regalo's",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(70, 4);

CALL cadastrarLocal(0, "Relojoaria Zenith",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(71, 5);

CALL cadastrarLocal(0, "John John",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(72, 4);

CALL cadastrarLocal(0, "Cia Marítima",  0, '09:25:00', '19:35:00', "7deb1582-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(73, 4);
...
CALL cadastrarLocal(12, "Nextel",  2, '08:00:00', '23:30:00', "7deb033a-f928-11ea-adc1-0242ac120002");

CALL cadastrarLocal(0, "Chocolatey",  0, '10:00:00', '23:59:59', "7deb16ae-f928-11ea-adc1-0242ac120002");
CALL defCategoriaLocal(78, 7);
...
CALL cadastrarLocal(12, "Banco do Brasil",  1,  '11:00:00', '21:30:00', "7deb132a-f928-11ea-adc1-0242ac120002");
CALL cadastrarLocal(12, "Banco Pan",  1,  '09:25:00', '21:00:00', "7deb132a-f928-11ea-adc1-0242ac120002");
CALL cadastrarLocal(12, "Lotérica Praiamar Shopping",  0,  '09:25:00', '18:00:00', "7deb132a-f928-11ea-adc1-0242ac120002");
...
CALL defCategoriaLocal(114, 0);
CALL defCategoriaLocal(114, 2);
CALL defCategoriaLocal(114, 3);
...
CALL defCategoriaLocal(120, 4);

CALL cadastrarLocal(0, "Netshoes",  2,  '08:35:00', '23:35:00', "9afbcad0-a1a8-1bfa-aaba-ba4baf121091");
CALL defCategoriaLocal(121, 4);

CALL cadastrarLocal(0, "Dafiti",  2,  '08:35:00', '23:35:00', "7afbcad0-a1a8-1bfa-aaba-ba4baf121091");
CALL defCategoriaLocal(122, 4);

CALL cadastrarLocal(4, "Walmart",  2,  '08:35:00', '23:35:00', "7afbcad0-a1a8-1bfa-aaba-ba4baf121091");

CALL cadastrarLocal(0,  "Grupo SBF",  2,  '08:35:00', '23:35:00', "7afbcad0-a1a8-1bfa-aaba-ba4baf121091");
CALL defCategoriaLocal(124, 4);

CALL cadastrarLocal(0,  "Passarela",  2,  '08:35:00', '23:35:00', "7afbfad0-a1a8-1bfa-baba-ba4bff121091");
CALL defCategoriaLocal(125, 4);
...
CALL cadastrarLocal(1, "Subway",  3,  '09:25:00', '23:35:00', "adeb0ba0-f921-affa-adc1-0242ac120052");
...
CALL cadastrarLocal(1,"Big Esfiha", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"A Casa do Porco", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Mocotó", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Olympe", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Tuju", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");

CALL cadastrarLocal(1,"Pariji Bistrot", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL publicarComunicado(153, 2, null, "Prato do dia: escargot ao molho madeira", now(), DATE_ADD(now(), INTERVAL 3 hour);

CALL cadastrarLocal(1,"Pé de Fava", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Sujinho", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Pé pra fora", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Faceburger", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Churassic Park", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Bon Apetit", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"O Senhor dos Pasteis", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Facefood", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Demorô", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Bar dos Otários", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Restaurante Manioca", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Ritz", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Nagarê Sushi", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Churrascaria Rodeio", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Frevo", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Terraço Santista", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Outback", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Madero Steak House", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Papinha da Vovó", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Mania de Churrasco", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Spoleto", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Varanda Grill", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Restaurante Kitchin", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Bullger", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Croasonho", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Casa do Chocolate", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Amaretto", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Seiko Temakeria", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"The Max Grill", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Oakberry", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Restaurante Bambu", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Beduíno", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Nutri's Grill", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Motoburger", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Old Harbour", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Japa Ral Restaurante", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Yuki", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Suco Bagaço", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Sushi Garden", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Patroni Pizzas", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Casa do Pão de Queijo", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Salada Paulista", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Sabores do Mar", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Jerônimo", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"KFC", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Villa Di Pasta", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Vivenda do Camarão", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Divino Fogão", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Pizza Hut", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Nebuta Temakeria", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Raízes da Terra", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Junglê", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Pede mais!", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Cafeteria Plaza", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Quero BIS", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Gostosuras ou gostosuras", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"A Grande Garfada", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");
CALL cadastrarLocal(1,"Veg e Veg Burger", 3, '09:25:00', '23:35:00', "adef2310-f921-bdb1-a121-0342ac120052");

CALL cadastrarLocal(6, "Banheiro Praiamar Shopping | 3º Andar ",  3,  '08:00:00', '23:59:59', "9deb0cfe-f928-11ea-adc1-0242ac120013");
CALL cadastrarLocal(2, "Bebedouro Praiamar Shopping | 3º Andar ",  3,  '09:25:00', '19:35:00', "adeb0ba0-f928-11ea-adc1-0242ac120023");
CALL cadastrarLocal(8, "Escada Fixa Praiamar Shopping | 3º Andar ",  3,  '08:00:00', '23:59:59', "adeb0cf1-a928-11ea-adc1-0242ac120032");
CALL cadastrarLocal(9, "Escada Rolante Praiamar Shopping | 3º Andar ",  3,  '09:25:00', '19:35:00', "adeb0ba1-a928-11ea-adc1-0242ac130042");

CALL cadastrarLocal(10, "Elevador Praiamar Shopping | 3º Andar ",  3,  '09:25:00', '19:35:00', "adeb0ba0-f921-a1ea-adc1-0242ac120053");
CALL publicarComunicado(216, 2, null, "O elevador está no andar S2, subindo", now(), DATE_ADD(now(), INTERVAL 3 second));
CALL publicarComunicado(216, 2, null, "O elevador está no andar S1, subindo", now(), DATE_ADD(now(), INTERVAL 3 second));
CALL publicarComunicado(216, 2, null, "O elevador está no andar térreo, subindo", now(), DATE_ADD(now(), INTERVAL 3 second));
CALL publicarComunicado(216, 2, null, "O elevador está no primeiro andar, subindo", now(), DATE_ADD(now(), INTERVAL 3 second));
CALL publicarComunicado(216, 3, null, "O elevador está no segundo andar, quase chegando", now(), DATE_ADD(now(), INTERVAL 3 second));
CALL publicarComunicado(216, 3, null, "O elevador chegou ao seu andar!", now(), DATE_ADD(now(), INTERVAL 5 second));

CALL cadastrarLocal(3, "Cinema Roxy | Recepção",  4,  '08:00:00', '23:59:59', "8deafcfe-f928-11ea-adc1-0242ac120013");
...
CALL cadastralLocal(11, "Praça de Alimentação", 3, '09:00:00', '23:00:00', "8deb0ba0-f921-a1ea-adc1-02bfac120053");
CALL cadastralLocal(11, "Praça de Descanso (com Wi-Fi)", 4, '09:00:00', '23:00:00', "8deb0ba0-f921-a1ea-adc1-02bfac120053");

CALL cadastrarLocal(13, "TLocal 1 | Térreo ",  0,  '00:00:00','00:00:00', "8deb0ba0-f921-a1ea-adc1-02bfac120053");
