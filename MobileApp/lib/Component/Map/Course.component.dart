  ...
  Course getCourseDirection(double azi){
    Course c = new Course().toCourse(azi);
        ...
        switch (c.collateralDirection) {
          case "NE":
              c.degress > 45 ?
              c = new Course(degress: c.degress, collateralDirection: "SE", cardialDirection: "E"):
              c = new Course(degress: c.degress, collateralDirection: "NE", cardialDirection: "N");
            break;
          case "SE":
              c.degress > 45 ?
              c = new Course(degress: c.degress, collateralDirection: "SE", cardialDirection: "E"):
              c = new Course(degress: c.degress, collateralDirection: "SE", cardialDirection: "S");
            break;


           case "SW":
              c.degress > 45 ?
              c = new Course(degress: c.degress, collateralDirection: "SW", cardialDirection: "W"):
              c = new Course(degress: c.degress, collateralDirection: "SE", cardialDirection: "S");
            break;
