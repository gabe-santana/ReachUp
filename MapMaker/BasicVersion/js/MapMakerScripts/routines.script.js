...
function draw(obj) {
    ...
    cbHall ? setDraw(hallColor, obj, 'h') :
        cbCorner ? setDraw(cornerColor, obj, 'c') :
            cbBeacon ? setDraw(beaconColor, obj, 'b') :
                cbILocal ? setDraw(IlocalColor, obj, 'il') :
                    cbELocal ? setDraw(ElocalColor, obj, 'el') : null;
